...
>
  ...
  dangerouslySetInnerHTML={{
            ...
            <div className="fixed bottom-0 left-0 right-0 z-50 flex justify-center gap-3 border-t border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-900">
              <button
